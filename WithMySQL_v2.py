...
def update_record():
    ...
    # Update record
    my_tree.item(selected, text="", values=(id_entry.get(), num_entry.get(), profil_entry.get(), nomposte_entry.get(),ipposte_entry.get(),masque_entry.get(),ipglory_entry.get(),balance_entry.get()),)
...
def add_record():
	...
	# Add New Record
	c.execute("INSERT INTO magasin (ID, Numéro, Nom, format, Code_CARINE, Profil, Nom_poste, Terminal, Opérateur, Pwd, IP_poste, Masque, Passerelle, Nom_Master, IP_Master, IP_Glory, Balance, Type_SCA, Cash, EAS) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
		(id_entry.get(), num_entry.get(), profil_entry.get(), nomposte_entry.get(),ipposte_entry.get(),masque_entry.get(),ipglory_entry.get(),balance_entry.get()))
...
update_button = customtkinter.CTkButton(button_frame, text="Update Record", command=update_record,width=50, height=20)
update_button.grid(row=0, column=0, padx=10, pady=10)

add_button = customtkinter.CTkButton(button_frame, text="Add Record", command=add_record,width=50, height=20,fg_color='green')
add_button.grid(row=1, column=0, padx=10, pady=10)

remove_all_button = customtkinter.CTkButton(button_frame, text="Remove All Records", command=remove_all,width=50, height=20,fg_color='#F816BC')
remove_all_button.grid(row=2, column=0, padx=10, pady=10)

remove_one_button = customtkinter.CTkButton(button_frame, text="Remove One Selected", command=remove_one,width=50, height=20,fg_color='red')
remove_one_button.grid(row=3, column=0, padx=10, pady=10)

remove_many_button = customtkinter.CTkButton(button_frame, text="Remove Many Selected", command=remove_many,width=50, height=20,fg_color='#F81652')
remove_many_button.grid(row=4, column=0, padx=10, pady=10)

move_up_button = customtkinter.CTkButton(button_frame, text="Move Up", command=up,width=50, height=20,fg_color='#F87B16')
move_up_button.grid(row=5, column=0, padx=10, pady=10)

move_down_button = customtkinter.CTkButton(button_frame, text="Move Down", command=down,width=50, height=20,fg_color='#F87B16')
move_down_button.grid(row=6, column=0, padx=10, pady=10)

select_record_button = customtkinter.CTkButton(button_frame, text="Clear Entry Boxes", command=clear_entries,width=50, height=20,fg_color='#DCD82D')
select_record_button.grid(row=7, column=0, padx=10, pady=10)
...
id_entry = customtkinter.CTkEntry(data_frame, fg_color='silver' ,width=100, height=20, border_width=1)
id_entry.grid(row=0, column=1, padx=5, pady=5)

num_label = customtkinter.CTkLabel(data_frame, text="Numéro")
num_label.grid(row=0, column=2, padx=10, pady=10)
num_entry = customtkinter.CTkEntry(data_frame, fg_color='silver',width=100, height=20)
...
nom_entry = customtkinter.CTkEntry(data_frame, fg_color='silver',width=100, height=20)
...
format_entry = customtkinter.CTkEntry(data_frame, fg_color='silver',width=100, height=20)
...
carine_entry = customtkinter.CTkEntry(data_frame, fg_color='silver',width=100, height=20)
...
profil_entry = customtkinter.CTkEntry(data_frame, fg_color='silver',width=100, height=20)
...
nomposte_entry = customtkinter.CTkEntry(data_frame, fg_color='silver',width=125, height=20)
...
terminal_entry = customtkinter.CTkEntry(data_frame, fg_color='silver',width=100, height=20)
...
operateur_entry = customtkinter.CTkEntry(data_frame, fg_color='silver',width=100, height=20)
...
pwd_entry = customtkinter.CTkEntry(data_frame, fg_color='silver',width=100, height=20)
...
ipposte_entry = customtkinter.CTkEntry(data_frame, fg_color='silver',width=100, height=20)
...
masque_entry = customtkinter.CTkEntry(data_frame, fg_color='silver',width=100, height=20)
...
passerelle_entry = customtkinter.CTkEntry(data_frame, fg_color='silver',width=100, height=20)
...
nommaster_entry = customtkinter.CTkEntry(data_frame, fg_color='silver',width=125, height=20)
...
ipmaster_entry = customtkinter.CTkEntry(data_frame, fg_color='silver',width=100, height=20)
...
ipglory_entry = customtkinter.CTkEntry(data_frame, fg_color='silver',width=100, height=20)
...
balance_entry = customtkinter.CTkEntry(data_frame, fg_color='silver',width=100, height=20)
...
sca_entry = customtkinter.CTkEntry(data_frame, fg_color='silver',width=100, height=20)
...
cash_entry = customtkinter.CTkEntry(data_frame, fg_color='silver',width=100, height=20)
...
eas_entry = customtkinter.CTkEntry(data_frame, fg_color='silver',width=100, height=20)
...
def version_qvs():
	...
	messagebox.showinfo(message_evenements)	
...
ultravnc_button = customtkinter.CTkButton(button_frame2, text="ULTRAVNC", command=connect_ultravnc,width=50, height=20)
ultravnc_button.grid(row=1, column=0, padx=10, pady=10)

ping_button = customtkinter.CTkButton(button_frame2, text="PING", command=test_ping,width=50, height=20)
ping_button.grid(row=2, column=0, padx=10, pady=10)

redemarrer_button = customtkinter.CTkButton(button_frame2, text="REDEMARRER", command=redemarrer,width=50, height=20)
redemarrer_button.grid(row=2, column=0, padx=10, pady=10)

bureau_button = customtkinter.CTkButton(button_frame2, text="Bureau à distance", command=connect_bureau,width=50, height=20)
bureau_button.grid(row=3, column=0, padx=10, pady=10)

dns_button = customtkinter.CTkButton(button_frame2, text="Serveurs DNS", command=DNS_comparison,width=50, height=20)
dns_button.grid(row=4, column=0, padx=10, pady=10)

fichLog_button = customtkinter.CTkButton(button_frame2, text="Fichier Log", command=fichier_logs,width=50, height=20)
fichLog_button.grid(row=5, column=0, padx=10, pady=10)

fichConfig_button = customtkinter.CTkButton(button_frame2, text="Fichier Config", command=fichier_param,width=50, height=20)
fichConfig_button.grid(row=6, column=0, padx=10, pady=10)

qvs_button = customtkinter.CTkButton(button_frame2, text="QVS Version", command=version_qvs,width=50, height=20)
qvs_button.grid(row=7, column=0, padx=10, pady=10)

fastlane_button = customtkinter.CTkButton(button_frame2, text="Fastlane Version", command=version_fastlane,width=50, height=20)
fastlane_button.grid(row=8, column=0, padx=10, pady=10)

system_button = customtkinter.CTkButton(button_frame2, text="System Events", command=system_events,width=50, height=20)
system_button.grid(row=9, column=0, padx=10, pady=10)
